...
module.exports = function testmod(d) {
	d.dispatch.addDefinition("C_PUT_WARE_ITEM", 3, path.join(__dirname, "defs", "C_PUT_WARE_ITEM.3.def"));
	d.dispatch.addDefinition("S_VIEW_WARE_EX", 2, path.join(__dirname, "defs", "S_VIEW_WARE_EX.2.def"));
